...
pub(crate) async fn capabilities_api(
    ...
    json_response(
        ...
        json!({
            ...
            "endpoints": [
                {"protocol": "http", "method": "GET/HEAD", "path": "/get"},
                {"protocol": "http", "method": "POST", "path": "/post"},
                {"protocol": "http", "method": "PUT", "path": "/put"},
                {"protocol": "http", "method": "PATCH", "path": "/patch"},
                {"protocol": "http", "method": "DELETE", "path": "/delete"},
                {"protocol": "http", "method": "*", "path": "/anything"},
                {"protocol": "http", "method": "*", "path": "/anything/"},
                {"protocol": "http", "method": "*", "path": "/anything/{*path}"},
